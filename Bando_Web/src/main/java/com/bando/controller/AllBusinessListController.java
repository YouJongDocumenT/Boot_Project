...
public class AllBusinessListController {
	...
	public String AllPruChaseList(Model model) throws Exception {
	...
	// 총 판매 내역 화면단
	@GetMapping("SellList")
	public String AllSellList(Model model) throws Exception {
		
		// 각 판매 관련 테이블의 client_id및 machine_id에 매칭된 모든데이터 출력
		model.addAttribute("SellMachingDataList", ccs.SellMachingDataList());
		logger.info("구매처 정보 매칭");
